...
function Meta(m)
    ensureHtmlDeps()
    local wrapper_class = 'social-share-wrapper'
    if m.share.divclass then
        wrapper_class = wrapper_class .. ' ' .. pandoc.utils.stringify(m.share.divclass)
    end
    local share_start = '<div class="' .. wrapper_class .. '"><div class="social-share">'
