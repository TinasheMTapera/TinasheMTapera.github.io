...
documentation with the world:

```bash
# seriously it's that easy;
# great-docs detects the optimal gh actions workflow from your uv config!
great-docs setup-github-pages
```

. Happy coding, and remember, documentation is not a chore, 
